...
const BasicCaption = ({
  ...
  trackItem: ITrackItem & ICaptionExtended;
}) => {
  ...
  useEffect(() => {
    ...
    setProperties({
      ...
      activeColor: trackItem.details.activeColor || "#50FF12",
      activeBackgroundColor:
        trackItem.details.activeBackgroundColor || "#7E12FF",
    });
  }, [trackItem.id]);
  ...
  const handleActiveBackgroundColorChange = (color: string) => {
    setProperties((prev) => {
      return {
        ...prev,
      ...
      <ScrollArea className="h-full">
        <div className="flex flex-col gap-2 px-4">
          <div className="flex flex-col gap-2">
            ...
            />
            <ActiveColor
              value={properties.activeColor}
              handleColorChange={handleActiveColorChange}
            />
            <ActiveBackgroundColor
              value={properties.activeBackgroundColor}
              handleColorChange={handleActiveBackgroundColorChange}
            />
          </div>
          <div className="grid grid-cols-2 gap-2">
            <Alignment
    ...
    <div className="flex flex-col gap-2 py-0">
      ...
      <div className="flex gap-2">
        <Popover>
          <PopoverTrigger asChild>
            <div
              style={{ background: localValue || "#50FF12" }}
              className="h-9 w-9 flex-none cursor-pointer rounded-md border border-border"
            ></div>
          </PopoverTrigger>
          <PopoverContent className="z-[300] w-full p-0">
    ...
    <div className="flex flex-col gap-2 py-0">
      ...
      <div className="flex gap-2">
        <Popover>
          <PopoverTrigger asChild>
            <div
              style={{ background: localValue || "#7E12FF" }}
              className="h-9 w-9 flex-none cursor-pointer rounded-md border border-border"
            ></div>
          </PopoverTrigger>
          <PopoverContent className="z-[300] w-full p-0">
